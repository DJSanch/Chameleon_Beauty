    ...
    >
      <div className="container">
        <div className="relative -mx-4 flex items-center justify-between lg:justify-between">
          ...
          {/* Navigation Menu */}
          <div className="flex w-full items-center justify-center lg:ml-32">
                    ...
                    <li key={index} className="group relative">
                      {menuItem.path ? (
                        ...
                        <>
                          ...
                          <div
                            className={`submenu relative left-0 top-full rounded-sm bg-white transition-[top] duration-300 group-hover:opacity-100 lg:invisible lg:absolute lg:top-[110%] lg:block lg:w-[200px] lg:p-3 lg:opacity-0 lg:shadow-lg lg:group-hover:visible lg:group-hover:top-full ${
            ...
            <div className="relative lg:hidden">
              ...
              <nav
                id="navbarCollapse"
                className={`navbar absolute right-2 top-full z-30 w-[200px] rounded border-[.5px] border-body-color/50 bg-white px-3 py-2 duration-300 ${
                  navbarOpen
                    ? "opacity-100 visible"
