            ...
            >
              <div className="relative max-w-screen-lg max-h-screen flex items-center justify-center">
                <Image
                  ...
                  alt={`fullscreen-image-${currentImage}`}
                  width={800} // Default width
                  height={600} // Default height
                  style={{ objectFit: 'contain' }}
                  className="transition-transform duration-300 ease-in-out transform scale-100" // Ensure the image is centered and scaled
                />
                <button
                  className="absolute top-1/2 left-4 transform -translate-y-1/2 bg-white p-2 rounded-full shadow-lg z-50"
                  onClick={(e) => {
                    e.stopPropagation();
                    handlePrevImage();
                  }}
                ...
                <button
                  className="absolute top-1/2 right-4 transform -translate-y-1/2 bg-white p-2 rounded-full shadow-lg z-50"
                  onClick={(e) => {
                    e.stopPropagation();
                    handleNextImage();
                  }}
